...
using MinimalAPI_Book;
using MinimalAPI_Book.Data;
using MinimalAPI_Book.Endpoint;
...
////Update
//app.MapPut("/api/updateBook/{id}", async (Guid id, [FromBody] BookUpdateDTO bookUpdateDTO, IBookRepository bookRepository, IValidator<BookUpdateDTO> validator) =>
//{
//    try
//    {
//        //WithOut APIResponse
